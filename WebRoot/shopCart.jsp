...
<%@ page import="java.util.ArrayList,com.po.GoodInfo,com.po.ShopCart" %>
<%
    	...
    	<div class="good">
    		...
    		<div class="content">
    			...
    			<div class="numInfo">
    				...
    				<div class="action"><a href="doCartServlet?action=remove&name=<%=name%>">移除</a></div>
    			</div>
    		</div>
    	</div>
    	<%
    	 ...
    	 <div class="bottom">
    	 	...
    	 	<span class="clear"><a href="doCartServlet?action=clear">清空购物车</a></span>
    	 </div>
    </div>
  </body>
</html>
